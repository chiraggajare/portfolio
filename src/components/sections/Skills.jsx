    ...
    <div>
      ...
      <div className="skills-grid">
        <div className="skill-card">
          <div className="skill-card-icon" style={{ background: 'rgba(124,58,237,0.15)' }}>🖥️</div>
          <h3>Frontend</h3>
        ...
        <div className="skill-card">
          <div className="skill-card-icon" style={{ background: 'rgba(6,182,212,0.15)' }}>⚙️</div>
          <h3>Backend</h3>
          <div className="skill-tags">
        ...
        <div className="skill-card">
          <div className="skill-card-icon" style={{ background: 'rgba(244,114,182,0.15)' }}>🗄️</div>
        ...
        <div className="skill-card">
          <div className="skill-card-icon" style={{ background: 'rgba(59,130,246,0.15)' }}>🛠️</div>
          <h3>Tools & More</h3>
          <div className="skill-tags">
